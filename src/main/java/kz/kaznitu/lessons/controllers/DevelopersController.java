...
public class DevelopersController {
    ...
    public String developersAdd(@RequestParam String email,
        ...
        newDeveloper.setItems(items);
        newDeveloper.setReceipt(receipt);
        newDeveloper.setPhoneNumber(phoneNumber);
    ...
    public String skillsAdd(@ModelAttribute("skill") @Valid Skill skill, Errors errors, Model model){
        if(errors.hasErrors()){
            return "skills";
        }
